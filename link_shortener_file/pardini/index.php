...
if ($_POST) {
    ...
    // Inserito correttamente nel DB, questo è il testo del file che si occuperà di effettuare l'aggiornamento delle visite e il redirect
    $text = '<?php
    include_once "../dbUtils.php";
    $conn = connetti();
